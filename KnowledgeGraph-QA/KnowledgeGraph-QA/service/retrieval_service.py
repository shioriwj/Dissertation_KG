...
class RetrievalBot(BaseLogger):
    def __init__(self, **kwargs):
        ...
        self.triple_core = SolrAPIHandler(TRIPLE_CORE_NAME)  # solr triple core
    ...
    def _is_similarity(self, query_words, doc_words):
        ...
        :return: 相似度得分
        """
        distance = calculate_wmd(query_words, doc_words)  # compute the distance between the question and the doc
